...
% 	    \begin{subfigure}[b]{\linewidth}
% 	        \centering
% 	        \includegraphics[width=\linewidth]{bgp-route-ipv6-2}
% 	        \caption{Router 2 (BT-R002)}
% 	    \end{subfigure}
% 	    \\
% 	    \begin{subfigure}[b]{\linewidth}
% 	        \centering
% 	        \includegraphics[width=\linewidth]{bgp-route-ipv6-3}
% 	        \caption{Router 3 (BT-R003)}
% 	    \end{subfigure}
% 	\end{minipage}
%     \caption{IPv6 Routes Collected through BGP Protocols on All $3$ Routers using \texttt{show bgp ipv6}.}
...
%     \end{subfigure}
%     \caption{IPv4 Routes to Central Network on Laptop 1 (BT001) using \texttt{traceroute}.}
